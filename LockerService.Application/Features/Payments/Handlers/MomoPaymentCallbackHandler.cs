...
public class MomoPaymentCallbackHandler : IRequestHandler<MomoPaymentCallback>
{
    ...
    public MomoPaymentCallbackHandler(IUnitOfWork unitOfWork, IRabbitMqBus rabbitMqBus, ILogger<MomoPaymentCallbackHandler> logger)
    {
    ...
    public async Task Handle(MomoPaymentCallback request, CancellationToken cancellationToken)
    {
        ...
        payment.ReferenceTransactionId = request.TransId;
