...
{
    /// <inheritdoc />
    public partial class AddLockerOrderTypeTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LockerOrderType", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LockerOrderType_Locker_LockerId",
                        column: x => x.LockerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LockerOrderType_LockerId",
