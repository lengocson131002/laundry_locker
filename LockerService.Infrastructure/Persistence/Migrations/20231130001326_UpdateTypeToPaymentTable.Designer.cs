...
namespace LockerService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231130001326_UpdateTypeToPaymentTable")]
    partial class UpdateTypeToPaymentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LockerService.Domain.Entities.ShippingPrice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LockerService.Domain.Entities.Wallet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LockerService.Domain.Entities.Wallet", b =>
                {
                    b.HasOne("LockerService.Domain.Entities.Account", "Customer")
                        .WithOne("Wallet")
                        .HasForeignKey("LockerService.Domain.Entities.Wallet", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
